namespace ePaperLive.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ePaperLive.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ePaperLive.Models.ApplicationDbContext context)
        {
            ...
            new printandsubrate() { Rateid = 23, Market = "Local", Type = "Print", RateDescr = "Sunday & Sunday Only", PrintDayPattern = "1000001", PrintTerm = 8, PrintTermUnit = "Weeks", Curr = "JMD", Rate = 1963.43, SortOrder = 1, Active = true },
            new printandsubrate() { Rateid = 24, Market = "Local", Type = "Print", RateDescr = "Sunday & Sunday Only", PrintDayPattern = "1000001", PrintTerm = 16, PrintTermUnit = "Weeks", Curr = "JMD", Rate = 3797.87, SortOrder = 1, Active = true },
            new printandsubrate() { Rateid = 25, Market = "Local", Type = "Print", RateDescr = "Sunday & Sunday Only", PrintDayPattern = "1000001", PrintTerm = 32, PrintTermUnit = "Weeks", Curr = "JMD", Rate = 7300.77, SortOrder = 1, Active = true },
